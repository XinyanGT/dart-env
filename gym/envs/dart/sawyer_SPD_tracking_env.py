...
class DartSawyerSPDTrackingEnv(dart_env.DartEnv, utils.EzPickle):
    def __init__(self):
        ...
        dart_env.DartEnv.__init__(self, 'sawyer_description/urdf/sawyer_arm_hoop.urdf', 5, obs_dim, self.control_bounds, disableViewer=False)
