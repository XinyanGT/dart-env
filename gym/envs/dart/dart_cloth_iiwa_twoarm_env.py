...
class DartClothIiwaTwoarmEnv(DartClothIiwaEnv):
    ...
    def additionalResets(self):
        ...
        human_efL = self.human_skel.bodynodes[12].to_world(self.fingertip)
        ...
        while (not good):
            ...
            #cut off points closer to the human than the end effector
            if p0L[2] > human_efL[2] or p0R[2] > human_efL[2]:
                good = False
